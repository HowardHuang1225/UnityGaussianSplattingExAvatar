...
public class HumanGaussianInferencePERSONA : MonoBehaviour
{
    public static readonly List<HumanGaussianInferencePERSONA> Instances = new List<HumanGaussianInferencePERSONA>();
    ...
    private void InitializeJointPosData()
    {
        ...
        // --- 更新公開的 Tensor 屬性 ---
        ScaleOutputTensor = static_worker.PeekOutput("scale") as Tensor<float>;
